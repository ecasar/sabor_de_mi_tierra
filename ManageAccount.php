...
<body>
    ...
    <div class="brand">Sabores De Mi Tierra</div>
                ...
                <div class="col-lg-12">
					...
					<div class="col-md-6">	
							...
							<div class="form-group">
							  ...
							  <input type="text" name="EmailAddress" class="form-control" id="EmailAddress" value="<?php echo $C_Email; ?>" disabled>
							</div>
