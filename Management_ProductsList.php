    ...
    <div class="container">
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
					<hr>
					<h2 class="intro-text text-center">Lista de Platillos</h2>
					<hr>
					<div class="col-lg-12">
						<div class="table-responsive">
							<table border="5px" class="table">
								<tr style="text-align: center; color: Black; font-weight: bold;">
									<td>Imagen</td>
									<td>ID de Platillo</td>
									<td>Nombre de Platillo</td>
									<td>Comida Tipica o ESpecialidad de la casa</td>
									<td>Tamaño del Platillo</td>
									<td>Incluye bebida</td>
