            ...
            <div class="box">
                <div class="col-lg-12">
					...
					<div class="col-md-6">	
							...
							<div class="form-group">
							  <label for="EmailAddress">Numero de Telefono:</label>
							  <input type="text" name="EmailAddress" class="form-control" id="EmailAddress" placeholder="Ingresa tu dirección de correo">
							</div>
