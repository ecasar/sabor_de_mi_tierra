            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong> Sabor de Mi Tierra</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <p>Sabor De Mi Tierra es una empresa Guatemalteca que se dedica a hacer platillos tipicos de Guatemala</p>
                    <p><a href = ""><b></b></a></p> 
                    <p>En Sabor de Mi Tierra encontraras los mejores platillos de La gastronomia Tipica Guatelmateca como tambien una extensa variedad de platillos para degustar en familia.</p>
                    <p><a href=""></a></p>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                   <p>
					...
					Copyright &copy; Sabor De Mi Tierra
					</p>
                </div>
            </div>
        </div>
