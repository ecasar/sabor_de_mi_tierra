        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<li><a href="index.php">Inicio</a></li>
					<li><a href="bestseller.php">Platillos Populares</a></li>
					<li><a href="shop.php">Platillos</a></li>
    ...
    <div class="container">
			...
			<div class="row">
				<div class="box" style="border-radius: 10px;">
					<div class="col-lg-12">
						<hr>
						<h2 class="intro-text text-center">Top 5 Los <strong>Más</strong> Populares</h2>
						<hr>
					</div><br></br>
				</div>
			</div>
						...
						<div class="row">
							<div class="box" style="border-radius: 10px;">
								<div class="col-lg-12">
									...
									<p><strong>Comida Tipica o Especialidad de la casa:</strong> '.$Rows[2].'</p>
									<p><strong>Observaciones:</strong> '.$Rows[3].'</p>
									<p><strong>Bebidas disponibles:</strong> '.$Rows[4].'</p>
									<p><strong>Precio: Q</strong> '.$Rows[5].'</p>
									<a onclick="addToCartOnclick('.$Rows[0].');" href="#"  style="margin-bottom: 5px;" class="btn btn-primary">Ordenar Platillo</a>
								</div>
							</div>
						</div>';
					$num--;
