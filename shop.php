...
<head>
    ...
    <title>Sabor De Mi Tierra</title>
		...
		<div class="col-sm-4 col-lg-4 col-md-4">
             <div class="thumbnail">
                ...
                <div class="caption">
					...
					<p><strong>Bebida Disponible:</strong> '.$Rows[4].'</p>
					<p><strong>Precio: Q '.$Rows[5].'.00</strong></p>
                </div>
				<center><a onclick="addToCartOnclick('.$Rows[0].');" href="#"  style="margin-bottom: 5px;" class="btn btn-primary">Ordenar Platillo</a></center>
            </div>
        </div>
		';
		}?>
